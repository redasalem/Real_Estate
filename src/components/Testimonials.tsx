  ...
  return (
    <motion.div
     ...
     className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='testimonials'>  
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>اراء <span className='underline underline-offset-4
         decoration-1 under font-light'> العملاء </span></h1>
        <p className='text-gray-500 max-w-80 text-center mb-8 mx-auto text-xl'> اراء من اتمتلكوا عقارات منا </p>
